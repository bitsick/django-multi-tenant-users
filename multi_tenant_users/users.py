...
class AbstractUserMixin(models.Model):
    ...
    authorization. It may be combined with `multi_tenant_users.TenantUser` to
...
class TenantUser(AbstractBaseUser, TenantPermissionsDelegator):
    """An abstract Django user class that tracks tenant membership."""
    tenants = models.ManyToManyField(
        settings.TENANT_MODEL,
        verbose_name=_('tenants'),
        help_text=_('The tenants to which this user belongs.'),
        blank=True,
